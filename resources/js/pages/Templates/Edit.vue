    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="text-xl font-semibold leading-tight text-white">Edit Template</h2>
                    ...
                    <div class="p-6 h-full flex flex-col">
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div>
                                ...
                                <p class="text-zinc-400 text-xs mt-1">Instructions for the AI to generate pull request titles.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="text-zinc-400 text-xs mt-1">Instructions for the AI to generate pull request descriptions.</p>
                            </div>
...
const form = useForm({
    ...
    body_template: props.template.body_template,
    default_labels: props.template.default_labels || [],
